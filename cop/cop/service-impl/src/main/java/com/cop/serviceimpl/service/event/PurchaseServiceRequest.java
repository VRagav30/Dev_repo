...
public class PurchaseServiceRequest {
	...
	public Mmtotal generateMMTotalContra(Mmtotal mt) {
		...
		BigDecimal buomqty=transUtil.findBuqty(oh.getObjcode(), oh.getObjitnum(), loh.getObjcode(), loh.getObjitnum(), mt.getDocuom(), mt.getDocqty());
		...
		//COSTACC SAME AS IN SR IN COSTTOTAL - 27TH DEC 2020
